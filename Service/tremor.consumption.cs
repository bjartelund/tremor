...
namespace SimpleTresholdService
{
    public partial class Tremor
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("tremor.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Anomaly");
            if (labelColumn == null)
            {
                throw new Exception("Anomaly column not found. Make sure the name searched for matches the name in the schema.");
            }
